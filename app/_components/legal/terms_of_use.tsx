  ...
  return (
    <Typography gutterBottom>
      ...
      <Typography paragraph>
        この利用規約（以下、「本規約」といいます。）は、門屋弘毅（以下、「当方」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。
        <br />
        <br />
      ...
      <Typography paragraph>
        ...
        <br />
        当方は、本サービスの提供の停止または中断により、ユーザーまたは第三者が被ったいかなる不利益または損害についても、一切の責任を負わないもとします。
      </Typography>
      ...
      <Typography paragraph>
        ...
        本サービスに関して紛争が生じた場合には、松山地方裁判所を専属的合意管轄とします。
      </Typography>
    </Typography>
  );
};
